...
# 3. Add the RSVP toggle next to the brand logo
brand_logo_old = """{/* Interactive Brand Logo - Top Left */}
 <div
...
brand_logo_new = """{/* Interactive Brand Logo - Top Left */}
 ...
 {role === 'staff' && (
   <button
     onClick={async () => {
       ...
       if (success) {
         addToast(nextExempted ? "Opt-in blocked" : "Opt-in open", 'success');
       } else {
...
text = text.replace(brand_logo_old, brand_logo_new)
